  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 bg-gray-100 min-h-screen">
      <div className="bg-white rounded-xl shadow-lg overflow-hidden transform transition-all duration-300 hover:shadow-xl">
        <div className="px-6 py-8 bg-gradient-to-r from-blue-50 via-indigo-50 to-purple-50">
            ...
            <div className="flex items-center justify-between bg-gray-50 p-6 rounded-lg shadow-sm transition-all duration-300 hover:shadow-md">
              ...
              <div className="flex items-center space-x-6">
                ...
                <a
                  ...
                  className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-lg shadow-md hover:from-blue-700 hover:to-indigo-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all duration-300"
                >
        ...
        <div className="px-6 py-8">
          <h4 className="text-lg font-semibold text-gray-900 mb-6">Lookup Delivery Details</h4>
          <div className="flex flex-col md:flex-row gap-4">
            <input
              ...
              className="w-full md:w-1/2 px-4 py-2 bg-gray-50 border border-gray-200 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
            />
            <button
              onClick={fetchDeliveryDetails}
              className="px-4 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-lg shadow-md hover:from-blue-700 hover:to-indigo-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all duration-300"
            >
              Fetch Details
            </button>
          </div>
          ...
          {deliveryDetails && (
            <div className="mt-6 bg-gray-50 p-6 rounded-lg shadow-sm">
              <h5 className="text-lg font-semibold text-gray-900 mb-4">Delivery Details</h5>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <p className="text-sm font-medium text-gray-700">Delivery ID:</p>
                  <p className="text-lg text-gray-900">{deliveryDetails._id}</p>
                </div>
                <div>
                  <p className="text-sm font-medium text-gray-700">Order ID:</p>
                  <p className="text-lg text-gray-900">{deliveryDetails.orderId}</p>
                </div>
                <div>
                  <p className="text-sm font-medium text-gray-700">Driver ID:</p>
                  <p className="text-lg text-gray-900">{deliveryDetails.driverId || 'Not Assigned'}</p>
                </div>
                <div>
                  <p className="text-sm font-medium text-gray-700">Status:</p>
                  <p className={`text-lg capitalize ${getStatusColor(deliveryDetails.status).split(' ')[0]}`}>
                ...
                <div>
                  ...
                  <p className="text-lg text-gray-900">
                    {deliveryDetails.location.coordinates.join(', ')}
                  </p>
                </div>
                <div>
                  <p className="text-sm font-medium text-gray-700">Estimated Delivery Time:</p>
                  <p className="text-lg text-gray-900">
